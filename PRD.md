...
## Notebooks (2026-08-06)

Three persistent notebooks: personal diary (manual), dev diary (agent-logged via
la_diary - repo fixes, tools installed, bloopers, decisions), and an abridged
daily news digest pulled from aiwatcher-mcp. SQLite store, dashboard cards,
/notebooks webapp page. See SPEC.md for the full spec.
