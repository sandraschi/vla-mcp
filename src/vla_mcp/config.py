...
class VLAConfig:
    ...
    worldlabs_gen_tool: str
    worldlabs_gen_arg: str
    ...
    prefab_apps: bool
    pipeline_boomy_demo: str | None
    pipeline_generate_world: bool
    aiwatcher_base_url: str | None
    aiwatcher_api_key: str | None
    aiwatcher_push_enabled: bool
    ...
    def from_env(cls) -> VLAConfig:
        ...
        return cls(
            ...
            hf_xvla_repo=os.getenv("VLA_HF_XVLA_REPO", "2toINF/X-VLA-Pt"),
            ...
            worldlabs_gen_tool=os.getenv("VLA_WORLDLABS_GEN_TOOL", "generate_world_from_text"),
            worldlabs_gen_arg=os.getenv("VLA_WORLDLABS_GEN_ARG", "prompt"),
            yahboom_mcp_url=os.getenv("VLA_YAHBOOM_MCP_URL") or None,
